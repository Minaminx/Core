    ...
    void *arg)
{
    ...
    unsigned int            i;
#endif
#if (NGX_HTTP_V2 || NGX_HTTP_V2_SPDY)
    ngx_http_connection_t  *hc;
#endif
#if (NGX_HTTP_V2 || NGX_HTTP_V2_SPDY || NGX_DEBUG)
    ngx_connection_t       *c;
...
/// ssl_protocols TLSv1.2 TLSv1.3;
    ...
    if (NGX_HTTP_SSL_BITMASK == "TLSALL" && define TLS1_3_VERSION) {
        if (NGX_BORINGSSL_TLSVERSION_MAX == "TLS1_3_VERSION" || ! define NGX_BORINGSSL_TLSVERSION_MAX) {
    ...
    } else if (NGX_HTTP_SSL_BITMASK == "TLS13" && define TLS1_3_VERSION) {
        if (NGX_BORINGSSL_TLSVERSION_MAX == "TLS1_3_VERSION" || ! define NGX_BORINGSSL_TLSVERSION_MAX) {
            ngx_conf_merge_bitmask_value(conf->protocols, prev->protocols,
                                        (NGX_CONF_BITMASK_SET
                                        |NGX_SSL_TLSv1_3
        ...
        if (NGX_BORINGSSL_TLSVERSION_MAX == "TLS1_2_VERSION" || ! define NGX_BORINGSSL_TLSVERSION_MAX) {
            ngx_conf_merge_bitmask_value(conf->protocols, prev->protocols,
                                        (NGX_CONF_BITMASK_SET
                                        |NGX_SSL_TLSv1_2));
        } else {
        ...
        if (NGX_BORINGSSL_TLSVERSION_MAX == "TLS1_1_VERSION" || ! define NGX_BORINGSSL_TLSVERSION_MAX) {
            ngx_conf_merge_bitmask_value(conf->protocols, prev->protocols,
                                        (NGX_CONF_BITMASK_SET
                                        |NGX_SSL_TLSv1_1
                                        |NGX_SSL_TLSv1));
        ...
        if (NGX_BORINGSSL_TLSVERSION_MAX == "TLS1_VERSION" || ! define NGX_BORINGSSL_TLSVERSION_MAX) {
            ngx_conf_merge_bitmask_value(conf->protocols, prev->protocols,
                                        (NGX_CONF_BITMASK_SET
                                        |NGX_SSL_TLSv1));
        } else {
